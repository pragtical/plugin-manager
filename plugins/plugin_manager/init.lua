...
command.add(nil, {
  ...
  ["plugin-manager:purge"] = function() PluginManager:purge(PluginManager.view.progress_callback):done(function() core.log("Successfully purged ppm directory.") end) end,
