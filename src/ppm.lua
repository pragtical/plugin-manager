...
function Pragtical:get_binary_path(arch)
  ...
  return self.local_path .. PATHSEP .. "pragtical"
end
    ...
    for i,file in ipairs(self.files or {}) do
      if file.arch and common.grep(ARCH, function(e) return e == file.arch end)[1] then
        ...
        if archive then
          ...
          common.rename(self.local_path .. PATHSEP .. "dir" .. PATHSEP .. "pragtical", self.local_path .. PATHSEP .. "pragtical")
...
function ppm.pragtical_run(...)
  ...
  local pragtical = ppm.get_pragtical(version) or error("can't find pragtical version " .. version)
  local potential_addons, i = ppm.retrieve_addons(pragtical, arguments)
