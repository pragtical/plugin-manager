...
local HOME, USERDIR, CACHEDIR, JSON, VERBOSE, FILTRATION, MOD_VERSION, QUIET, FORCE, REINSTALL, NO_COLOR, AUTO_PULL_REMOTES, ARCH, ASSUME_YES, NO_INSTALL_OPTIONAL, TMPDIR, DATADIR, BINARY, POST, PROGRESS, SYMLINK, settings, repositories, pragticals, system_bottle, progress_bar_label, write_progress_bar
  ...
  if engage_locks(function()
    ...
    if pragtical_binary then
      ...
      if not system_pragtical then
        ...
        local pragtical_datadirs = { DATADIR, directory .. PATHSEP .. "data", directory:find(PATHSEP .. "bin$") and common.dirname(directory .. PATHSEP .. "share" .. PATHSEP .. "pragtical"), directory .. PATHSEP .. "data" }
